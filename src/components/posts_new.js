...
class PostsNew extends Component {
	...
	onSubmit(values) {
		this.props.createPost(values, () => {
			// Redux Router adds props to any component of a Route - ie: history
...
function validate(values) {
	// console.log(values) => { title: 'xxxx', categories: 'xxxx', content: 'xxxx' }
	const errors = {};
	...
	// If errors is empty ? form can submit : redux assumes form is invalid
	return errors;
}
